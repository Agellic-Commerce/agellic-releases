...
v1.6.0 is the current stable release, but distribution is still early-access:
...
### Do I need a new license for v1.6.0?

No. If you already have a v1.0.0 license token, it works as-is on v1.6.0:
